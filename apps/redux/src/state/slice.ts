...
import {
  INSTRUMENTS, NOW, SEED, START_PRICES, TRADE_COUNT,
  createTradeHistory, nextDirection, seedPositions,
} from '@smc/domain';
import type { InstrumentId, JournalFilter, Position, Quote, Trade } from '@smc/domain';
